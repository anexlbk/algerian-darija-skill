...
| Darija | From French | Meaning | Confidence |
|---|---|---|---|
| باطرون | patron | boss | common |
| بلان | plan | plan | common |
| بورطابل | portable | mobile phone | common |
| كوزينة | cuisine | kitchen / stove | common |
| طوموبيل | automobile | car | common |
| ڨاز | gaz | gas | common |
| بورتفاي | portefeuille | wallet | common |
| ساكادو | sac à dos | backpack | common |
| كرافاطة | cravate | tie | regional (more formal/workwear contexts) |
| بيبليسيتي | publicité | advertising | regional (marketing/business register) |
| بيل | pile | battery | regional (also just "باطري" from batterie, equally valid) |
| بوسطا | poste | post office | rare (younger speakers often just say "لابوست") |
| إسكو | est-ce que | question marker, synonym of واش | rare (dated/less common than واش) |
| باسكو | parce que | because, synonym of "على خاطر" | rare |
...
| Darija | Notes | Confidence |
|---|---|---|
| آيا | expression of surprise/disbelief | regional |
| أرسلان | "lion," used as a given name | common (as a name, not vocabulary) |

## Berber (Amazigh) origin

| Darija | Notes | Confidence |
|---|---|---|
| آيور | moon / moonlight, used in some regions | regional |
| اشبوب | hair, in some eastern-Algeria speech | regional |
| أغيول | donkey, also used as an insult ("idiot") | common (the insult usage is the Darija-specific part) |

## Useful expressions worth knowing (meaning, not literal translation)

| Expression | Meaning | Confidence |
|---|---|---|
| ثبت روحك (thebbet rohek) | focus and try to recall something | common |
| آحي | interjection of regret, resignation, or "yikes" | common |
| آواه | sharp interjection of refusal/disbelief ("no way") | common |
| زعما | "supposedly," skeptical/sarcastic edge | common |
| والو | "nothing at all" | common |
